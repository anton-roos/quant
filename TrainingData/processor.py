...
RAW_DIR = "training_data/indicators_data/raw"
PROCESSED_DIR = "training_data/indicators_data/processed"
...
def check_missing_today():
    ...
    # Check all subfolders: stocks, forex, commodities, SPY-VIX
    for subfolder in ["SPY-VIX", "stocksData", "forex", "commodities"]:
...
def main():
    # Process stock data, forex data, and commodities data
    for subfolder in ["SPY-VIX", "stocksData", "forex", "commodities"]:
